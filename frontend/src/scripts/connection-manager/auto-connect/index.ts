...
export default {
    components: {
        ListData: defineAsyncComponent({
            loader: () => import('@/views/connection-manager/auto-connect/components/List.vue'),
            loadingComponent: SkeletonBox,
        }),
        AddConnection: defineAsyncComponent({
            loader: () => import('@/views/connection-manager/auto-connect/components/AddConnection.vue'),
            loadingComponent: SkeletonBox,
        }),
