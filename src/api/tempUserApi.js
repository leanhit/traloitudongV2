...
export const tempUsersApi = {
    ...
    getTempUsersByConnection(connectionId) {
        return axios.get(`/odoo/temp-users/connection/${connectionId}`);
    },
    /**
     * Search temp users
     */
    searchTempUsers(searchParams) {
        return axios.get(`/odoo/temp-users/search`, { params: searchParams });
    },
    /**
     * Get temp user statistics
     */
    getTempUserStatistics() {
        return axios.get(`/odoo/temp-users/statistics`);
    }
};
